...
fun CameraScreen() {
    ...
    if (detectionResults.value != null) {
        ...
        val inferenceTimeThreshold = 250

        val isUsingGPU = remember { mutableStateOf(true) } // Tracks whether the GPU is currently in use

        // Check inference time and switch classifier if needed
